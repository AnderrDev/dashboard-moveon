  ...
  const onSubmit = async (data: ProductFormData) => {
    ...
    try {
      ...
      const updateData = {
        ...
        nutritional_info: product.nutritional_info, // Mantener información nutricional existente
        images: product.images, // Mantener imágenes existentes
      }
      ...
      addToast(error instanceof Error ? error.message : 'Error al actualizar el producto', 'error')
    } finally {
      setSaving(false)
    }
  }
